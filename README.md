...
This table lists the configuration variables required to operate Carbon Black Defense V2. These variables are specified when configuring a Carbon Black Defense asset in Splunk SOAR.
